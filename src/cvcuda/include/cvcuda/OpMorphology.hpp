...
public:
    ...
    void operator()(cudaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out,
                    ...
                    const int2 &anchor, int32_t iteration, const NVCVBorderType borderMode) const;
...
inline Morphology::Morphology()
{
    ...
    nvcv::detail::CheckThrow(cvcudaMorphologyCreate(&h));
    assert(h);
...
inline void Morphology::operator()(cudaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out,
                                   ...
                                   const NVCVBorderType borderMode) const
{
    nvcv::detail::CheckThrow(cvcudaMorphologySubmit(m_handle.get(), stream, in.handle(), out.handle(),
...
inline void Morphology::operator()(cudaStream_t stream, const nvcv::ImageBatchVarShape &in,
                                   ...
                                   int32_t iteration, const NVCVBorderType borderMode) const
{
    nvcv::detail::CheckThrow(cvcudaMorphologyVarShapeSubmit(m_handle.get(), stream, in.handle(), out.handle(),
