...
inline ResizeCropConvertReformat::ResizeCropConvertReformat()
{
    ...
    nvcv::detail::CheckThrow(cvcudaResizeCropConvertReformatCreate(&h));
    assert(h);
...
inline void ResizeCropConvertReformat::operator()(cudaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out,
                                                  ...
                                                  const float offset, const bool srcCast) const
{
    nvcv::detail::CheckThrow(cvcudaResizeCropConvertReformatSubmit(m_handle.get(), stream, in.handle(), out.handle(),
...
inline void ResizeCropConvertReformat::operator()(cudaStream_t stream, const nvcv::ImageBatchVarShape &in,
                                                  ...
                                                  const bool srcCast) const
{
    nvcv::detail::CheckThrow(cvcudaResizeCropConvertReformatVarShapeSubmit(m_handle.get(), stream, in.handle(),
                                                                           out.handle(), resizeDim, interpolation,
