...
private:
    mutable PerDeviceResource<nvcv::legacy::cuda_op::AverageBlur>         m_legacyOp;
    mutable PerDeviceResource<nvcv::legacy::cuda_op::AverageBlurVarShape> m_legacyOpVarShape;
};
