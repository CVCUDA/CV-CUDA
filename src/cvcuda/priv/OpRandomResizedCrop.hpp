...
private:
    mutable PerDeviceResource<nvcv::legacy::cuda_op::RandomResizedCrop>         m_legacyOp;
    mutable PerDeviceResource<nvcv::legacy::cuda_op::RandomResizedCropVarShape> m_legacyOpVarShape;
};
