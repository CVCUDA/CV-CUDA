 ...
 *
 * @brief Defines the private C++ Class for the AdjustSharpness operation.
 */

#ifndef CVCUDA_PRIV__ADJUST_SHARPNESS_HPP
#define CVCUDA_PRIV__ADJUST_SHARPNESS_HPP
...
#endif // CVCUDA_PRIV__ADJUST_SHARPNESS_HPP
