...
.. literalinclude:: ../../../../../samples/classification/python/model_inference.py
   :language: python
   :linenos:
   :start-after: begin_init_classificationtensorrt
   :end-before: end_init_classificationtensorrt
   :dedent:
...
.. literalinclude:: ../../../../../samples/classification/python/model_inference.py
   :language: python
   :linenos:
   :start-after: begin_call_classificationtensorrt
   :end-before: end_call_classificationtensorrt
   :dedent:
