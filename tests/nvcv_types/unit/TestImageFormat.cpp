...
TEST(ImageFormatTests, StrNVCVImageFormat)
{
    ...
    EXPECT_EQ(StrNVCVImageFormat(NVCV_IMAGE_FORMAT_LAB8), "NVCV_IMAGE_FORMAT_LAB8");
...
TEST(ImageFormatTests, operator_insertion)
{
    ...
    testOperatorInsertion("NVCV_IMAGE_FORMAT_LAB8", NVCV_IMAGE_FORMAT_LAB8);
    testOperatorInsertion("NVCV_IMAGE_FORMAT_LAB8p", NVCV_IMAGE_FORMAT_LAB8p);
    testOperatorInsertion("NVCV_IMAGE_FORMAT_LABf16", NVCV_IMAGE_FORMAT_LABf16);
    testOperatorInsertion("NVCV_IMAGE_FORMAT_LABf16p", NVCV_IMAGE_FORMAT_LABf16p);
    testOperatorInsertion("NVCV_IMAGE_FORMAT_LABf32", NVCV_IMAGE_FORMAT_LABf32);
    testOperatorInsertion("NVCV_IMAGE_FORMAT_LABf32p", NVCV_IMAGE_FORMAT_LABf32p);
