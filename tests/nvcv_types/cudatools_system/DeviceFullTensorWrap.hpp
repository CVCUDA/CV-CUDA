...
#ifndef NVCV_TESTS_DEVICE_FULL_TENSOR_WRAP_HPP
#define NVCV_TESTS_DEVICE_FULL_TENSOR_WRAP_HPP
...
void DeviceSetOnes(DstWrapper &, cudaStream_t &);

#endif // NVCV_TESTS_DEVICE_FULL_TENSOR_WRAP_HPP
