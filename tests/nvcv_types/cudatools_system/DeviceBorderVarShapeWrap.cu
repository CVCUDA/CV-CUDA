...
#include <cvcuda/cuda_tools/BorderVarShapeWrap.hpp>     // the object of this test
#include <cvcuda/cuda_tools/ImageBatchVarShapeWrap.hpp> // for ImageBatchVarShape, etc.
