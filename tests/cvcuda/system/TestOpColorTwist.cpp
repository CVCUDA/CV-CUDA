...
#define NVCV_IMAGE_FORMAT_RGB16U  NVCV_DETAIL_MAKE_COLOR_FMT1(RGB, UNDEFINED, PL, UNSIGNED, XYZ1, X16_Y16_Z16)
#define NVCV_IMAGE_FORMAT_RGB16S  NVCV_DETAIL_MAKE_COLOR_FMT1(RGB, UNDEFINED, PL, SIGNED, XYZ1, X16_Y16_Z16)
#define NVCV_IMAGE_FORMAT_RGBA16S NVCV_DETAIL_MAKE_COLOR_FMT1(RGB, UNDEFINED, PL, SIGNED, XYZW, X16_Y16_Z16_W16)
#define NVCV_IMAGE_FORMAT_RGB32U  NVCV_DETAIL_MAKE_COLOR_FMT1(RGB, UNDEFINED, PL, UNSIGNED, XYZ1, X32_Y32_Z32)
#define NVCV_IMAGE_FORMAT_RGBA32U NVCV_DETAIL_MAKE_COLOR_FMT1(RGB, UNDEFINED, PL, UNSIGNED, XYZW, X32_Y32_Z32_W32)
#define NVCV_IMAGE_FORMAT_RGB32S  NVCV_DETAIL_MAKE_COLOR_FMT1(RGB, UNDEFINED, PL, SIGNED, XYZ1, X32_Y32_Z32)
