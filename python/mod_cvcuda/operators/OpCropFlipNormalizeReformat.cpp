...
void ExportOpCropFlipNormalizeReformat(py::module &m)
{
    ...
    m.def("crop_flip_normalize_reformat", NvtxTrace("cvcuda.crop_flip_normalize_reformat", &CropFlipNormalizeReformat),
        ...
        Args:
            ...
            rect (cvcuda.Tensor): The crop rectangle tensor which has shape of [batch_size, 1, 1, 4] in reference to the input tensor.
            ...
            flip_code (cvcuda.Tensor): A tensor flag to specify how to flip the array; 0 means flipping around the x-axis,
