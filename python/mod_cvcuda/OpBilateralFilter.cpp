...
void ExportOpBilateralFilter(py::module &m)
{
    ...
    m.def("bilateral_filter", &BilateralFilter, "src"_a, "diameter"_a, "sigma_color"_a, "sigma_space"_a,
        ...
        cvcuda.bilateral_filter(src: nvcv.Tensor, diameter: int, sigma_color: float, sigma_space: float, border:cvcuda.Border = cvcuda.Border.CONSTANT, stream: Optional[nvcv.cuda.Stream] = None) -> nvcv.Tensor
    ...
    m.def("bilateral_filter_into", &BilateralFilterInto, "dst"_a, "src"_a, "diameter"_a, "sigma_color"_a,
        ...
        cvcuda.bilateral_filter_into(dst: nvcv.Tensor, src: nvcv.Tensor, diameter: int, sigma_color: float, sigma_space: float, border: cvcuda.Border = cvcuda.Border.CONSTANT, stream: Optional[nvcv.cuda.Stream] = None)
